...
При этом, если мы выполняем эту команду первый раз, то система попросит нас авторизоваться, так как изменения имеет право вносить лишь владелец аккаунта.
...
Если мы, решили помочь улучшить чужой проект, создали у себя его копию (fork) и внесли изменения, то для преложения автору проекта, наших изменений предназначена кнопка pull request
